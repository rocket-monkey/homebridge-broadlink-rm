...
describe("windowCoveringAccessory", () => {
  it("default config", async () => {
    ...
    const windowCoveringAccessory = new WindowCovering(
      null,
      config,
      "FakeServiceManager",
    );
  ...
  it("0% -> 50%", async () => {
    ...
    // Set Blinds to 50%
    windowCoveringAccessory.serviceManager.setCharacteristic(
  ...
  it('"initialDelay": 1', async () => {
    ...
    await delayForDuration(windowCoveringAccessory.config.initialDelay - 0.1);
  ...
  it("0% -> 100% -> 0%", async () => {
    ...
    // Check hex code was sent
    hasSentCodes = device.hasSentCodes([
      "OPEN_COMPLETELY",
      "STOP",
      "CLOSE_COMPLETELY",
    ]);
